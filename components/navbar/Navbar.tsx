...
const Navbar = () => {
  return (
    <div className='flex py-6 px-52 sticky top-0 border-b backdrop-blur-md align-middle gap-4 z-30'>
      <nav className='flex space-x-4 lg:space-x-6 items-center'>
        ...
        <Link href='/events' className='text-lg font-medium text-muted-foreground transition-colors hover:text-primary'>
          Nasze wydarzenia
        </Link>
      </nav>
